...
export default function UserLogIn() {
  ...
  return <div style={{backgroundColor: 'violet'}}>
    ...
    >
      ...
      Password
              ...
              <div className="submit">
                <Button type="submit" variant="contained" color="secondary" sx = {{borderRadius: 5, pl: 3, pr: 3, pt:1, fontWeight: '500' ,mb: 1, mt: 2 }}>LOGIN</Button>
              </div>
    ...
    ><span style={{color: 'indigo'}}>Create a new account</span></Link> | <span style={{color: 'indigo'}}>Forgot Password?</span>. 
            </Typography>
            </Form>
          );
        }}
